...
_WIKI_SYSTEM_PROMPT = (
    ...
    "environments, globals, snippets, insights, settings, and search. Live GUI scopes "
    ...
    "or run history. If workspace output says the result is authoritative, report it and "
