...
class _ChatPanelTranscriptLoadMixin:
    ...
    def _message_from_dict(self, msg: AiChatMessageDict) -> ChatMessageBubble:
        ...
        return self.add_message(  # type: ignore[attr-defined,no-any-return]
            ...
            lazy_markdown=self._transcript_load_lazy_markdown and role == "assistant",
        )
