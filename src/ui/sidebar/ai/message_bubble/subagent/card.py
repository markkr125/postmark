...
class SubagentTaskCard(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        header_row.addWidget(self._open_icon, 0, Qt.AlignmentFlag.AlignTop)
    ...
    def mouseReleaseEvent(self, event: QMouseEvent) -> None:
        """Open the detail window when the card is clickable."""
        if event.button() == Qt.MouseButton.LeftButton and self._status != "warming":
