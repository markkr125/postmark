...
class _HistoryDetailLoadWorker(QObject):
    """Loads history rows on a dedicated thread (``Signal(int, object)`` is thread-safe)."""
    ...
    def load_entry(self, generation: int, entry_id: int) -> None:
        ...
        self.finished.emit(generation, {"entry": entry, "detail": detail})


class HistoryDetailLoader(QObject):
    """Schedule :class:`_HistoryDetailLoadWorker` jobs (one result at a time)."""
    ...
    def __init__(self, parent: QObject | None = None) -> None:
        ...
        self._worker: _HistoryDetailLoadWorker | None = None
    ...
    def _ensure_worker_thread(self) -> None:
        ...
        self._worker = _HistoryDetailLoadWorker()
