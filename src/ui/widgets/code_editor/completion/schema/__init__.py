...
from ui.widgets.code_editor.completion.schema.js import JS_GLOBALS, JS_SCHEMA
from ui.widgets.code_editor.completion.schema.py import PY_GLOBALS, PY_SCHEMA
